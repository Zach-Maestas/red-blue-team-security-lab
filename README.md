...
This repo is my full cybersecurity lab portfolio — covering both sides of the fight. I built and broke into systems as the **attacker (Red Team)** and investigated + defended against attacks as the **responder (Blue Team)**, all in a controlled university lab environment.
...
- Investigated suspicious scanning and login activity across an instructor-provided dataset
- Correlated UFW firewall logs, SSH auth records, and packet captures
- Constructed an attack timeline and impact assessment
...
- Security hardening & mitigation strategies
